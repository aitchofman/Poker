...
tables[0] = new Table(4, 'Haackis 10-handed Table', eventEmitter(0), 10, 2, 1, 200, 40, false);
tables[0] = new Table(5, 'Nils 10-handed Table', eventEmitter(0), 10, 2, 1, 200, 40, false);
tables[0] = new Table(6, 'Free 10-handed Table', eventEmitter(0), 10, 2, 1, 200, 40, false);
tables[1] = new Table(1, 'Sample 6-handed Table', eventEmitter(1), 6, 4, 2, 400, 80, false);
tables[1] = new Table(7, 'Haackis 6-handed Table', eventEmitter(1), 6, 4, 2, 400, 80, false);
tables[1] = new Table(8, 'Nils 6-handed Table', eventEmitter(1), 6, 4, 2, 400, 80, false);
tables[1] = new Table(9, 'Free 6-handed Table', eventEmitter(1), 6, 4, 2, 400, 80, false);
tables[2] = new Table(2, 'Sample 2-handed Table', eventEmitter(2), 2, 8, 4, 800, 160, false);
tables[2] = new Table(10, 'Haackis 2-handed Table', eventEmitter(2), 2, 8, 4, 800, 160, false);
tables[2] = new Table(11, 'Nils 2-handed Table', eventEmitter(2), 2, 8, 4, 800, 160, false);
tables[2] = new Table(12, 'Free 2-handed Table', eventEmitter(2), 2, 8, 4, 800, 160, false);
